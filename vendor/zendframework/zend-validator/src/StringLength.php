...
//        self::INVALID   => "Tipo de dato no vàlido. Se esperaba una cadena de caracteres",
//        self::TOO_SHORT => "The input is less than %min% characters long",
//        self::TOO_LONG  => "The input is more than %max% characters long",
//    );
    protected $messageTemplates = array(
        self::INVALID   => "Tipo de dato inválido",
        self::TOO_SHORT => "La entrada tiene menos de %min% caracteres de longitud",
        self::TOO_LONG  => "La entrada tiene más de %max% caracteres de longitud",
    );
